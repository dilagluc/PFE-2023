...
@Component({
  selector: 'app-promotion-remove-dialog',
  templateUrl: './promotion-remove-dialog.component.html',
  styleUrls: ['./promotion-remove-dialog.component.scss'],
  providers: [
    ...
    { provide: MAT_DATE_FORMATS, useValue: YEAR_MODE_FORMATS },
    {
      ...
      useExisting: forwardRef(() => PromotionRemoveDialogComponent),
      multi: true,
    },
  ],
})
...
export class PromotionRemoveDialogComponent implements ControlValueAccessor,   OnInit{
  form!: FormGroup;
  selectedYear!: String
  ...
  constructor(
      public dialogRef: MatDialogRef<PromotionRemoveDialogComponent>,
